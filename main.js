...
random_name=Math.floor((Math.random()*quick_draw_data_set)+1);
sketch=quick_draw_data_set[random_name];
...
if(timercheck =="completed" || answerholder == "set") { timercheck = ""; answerholder = ""; updateCanvas(); }
}
...
document.getElementById("sketch").innerHTML="Your Sketch:"+drawnsketch;
